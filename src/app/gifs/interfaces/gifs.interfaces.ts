// To parse this data:
//
//   import { Convert, SearchGISResponse } from "./file";
//
//   const searchGISResponse = Convert.toSearchGISResponse(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SearchGISResponse {
  data: Gif[];
...
export class Convert {
  public static toSearchGISResponse(json: string): SearchGISResponse {
    return cast(JSON.parse(json), r('SearchGISResponse'));
  }

  public static searchGISResponseToJson(value: SearchGISResponse): string {
    return JSON.stringify(uncast(value, r('SearchGISResponse')), null, 2);
  }
}
